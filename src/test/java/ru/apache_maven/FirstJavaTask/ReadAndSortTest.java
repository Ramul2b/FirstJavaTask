...
/** Creating a text files in the user directory. In one of the files written random numbers*/
        BufferedWriter writeTextFile_Out = new BufferedWriter(new FileWriter(userDirectory + "/testOfClass_Out.txt"));
        BufferedWriter writeTextFile_In = new BufferedWriter(new FileWriter(userDirectory + "/testOfClass_In.txt"));
        ...
        outFile = ReadAndSortFile.writeInArrayAndSort( userDirectory + "/testOfClass_Out.txt" );
        inFile = ReadAndSortFile.writeInArrayAndSort( userDirectory + "/testOfClass_In.txt" );
